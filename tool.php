          ...
          <div class="all-one-accessibility-form">
                ...
                <div class="custom-position-controls hide">
                  <div class="row">
                    <div class="col-auto">
                      <div class="input-group mb-3">
                        <input type="number" style="height:auto" min="0" max="250" class="form-control"
                          id="custom_position_x_value" aria-label="Value in pixels" aria-describedby="pos-value-input_1"
                  ...
                  <div class="row">
                    <div class="col-auto">
                      <div class="input-group mb-3">
                        <input type="number" style="height:auto" min="0" max="250" class="form-control"
                          id="custom_position_y_value" aria-label="Value in pixels" aria-describedby="pos-value-input_2"
                          oninput="this.value = Math.min(Math.max(this.value, 0), 250)" />
            ...
            <div class="mb-3 row widget-position" id="position_html">
              ...
              <div class="col-sm-12 three-col">
                <div
                  ...
                  <input type="radio" id="edit-position-top-left" name="position" value="top_left" class="form-radio" />
            ...
            <div class="form-radios  mb-3">
              <div class="form-radio-item">
                <input data-drupal-selector="edit-widget-size-regularsize"
                  aria-describedby="edit-widget-size--description" <?php echo ('widget_size' == "0" ? "checked" : ""); ?>
                  type="radio" id="edit-widget-size-regularsize" name="widget_size" value="0" checked="checked"
              ...
              <div class="form-radio-item">
                <input data-drupal-selector="edit-widget-size-oversize" aria-describedby="edit-widget-size--description"
                  type="radio" <?php echo ('widget_size' == "1" ? "checked" : ""); ?> id="edit-widget-size-oversize"
            ...
            <div class="icon-type-wrapper row " id="select_icon_type">
              <label class="fcol-sm-12 col-form-label"
                style="margin-left: -10.500px; margin-right: -10.500px;color: black;">Select icon type:</label>
                    ...
                    <div class="col-auto controls">
                      ...
                      <div class="input-group mb-2">
                        <input type="number" class="form-control" style="height:auto" id="widget_icon_size_custom"
                          name="widget_icon_size_custom" min="20" max="150" value="" aria-label="Value in pixels"
                          aria-describedby="size-value-input_1" onblur="validateIconSize(this)" />
...
<script>
  ...
  function f1() {
    ...
    // Update widget settngs API to update settings on ADA dashboard
